      ...
      <div className="bg-white px-8 py-8 border border-gray-100 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        <div className="flex items-center gap-4 mb-8 text-gray-500">
          <label htmlFor="doc-img">
            <div className="w-32 h-32 border-2 border-zinc-400 rounded-full flex items-center justify-center bg-gray-100 cursor-pointer">
              {docImg ? (
                <img
                ...
                <i className="bi bi-person-fill-add text-3xl text-zinc-400"></i>
              )}
            </div>
          </label>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p className="text-black">Doctor Password</p>
              <input
        ...
        <div>
          <p className="mt-4 mb-2 text-black">About Doctor</p>
          <textarea
